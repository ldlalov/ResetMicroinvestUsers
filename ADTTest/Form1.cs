...
namespace ADTTest
{
    public partial class Reset : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)//Connect
        {
            ...
            {
                MessageBox.Show("Àêî ñòå óêàçàëè ñúðâúð, ïîïúëíåòå ïîòðåáèòåë è ïàðîëà");
                return;
            }
            else
            {
            ...
            {
                MessageBox.Show("Íåóñïåøíî ñâúðçâàíå");
                Success.Visible = false;
                comboBox1.Text = "";
                comboBox2.Text = "";
                comboBox1.Items.Clear();
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Áàçàòà íå å íà Ìèêðîèíâåñò");
                comboBox1.Items.Clear();
                comboBox1.Text = "";
                return;
            }
        ...
        public List<string> GetDatabaseList()
        {
            ...
            //conString = "server=localhost;uid=sa;pwd=AntoniLyubo;encrypt=false;";
